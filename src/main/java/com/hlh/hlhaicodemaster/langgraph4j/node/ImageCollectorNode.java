package com.hlh.hlhaicodemaster.langgraph4j.node;

import com.hlh.hlhaicodemaster.langgraph4j.ai.ImageCollectionPlanService;
import com.hlh.hlhaicodemaster.langgraph4j.ai.ImageCollectionService;
import com.hlh.hlhaicodemaster.langgraph4j.model.ImageCollectionPlan;
import com.hlh.hlhaicodemaster.langgraph4j.model.ImageResource;
import com.hlh.hlhaicodemaster.langgraph4j.state.WorkflowContext;
import com.hlh.hlhaicodemaster.langgraph4j.tools.ImageSearchTool;
import com.hlh.hlhaicodemaster.langgraph4j.tools.LogoGeneratorTool;
import com.hlh.hlhaicodemaster.langgraph4j.tools.MermaidDiagramTool;
import com.hlh.hlhaicodemaster.langgraph4j.tools.UndrawIllustrationTool;
import com.hlh.hlhaicodemaster.utils.SpringContextUtil;
...
/**
 * 图片收集节点
 * 使用AI进行工具调用（四种图片收集Tools），收集不同类型的图片
 */
@Slf4j
